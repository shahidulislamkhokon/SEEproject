...
<body>
	<header>
		<nav class="navbar navbar-expand-md navbar-dark"
			...
			<div>
				<a href="https://www.javaguides.net" class="navbar-brand"> Event Management
					 App</a>
			</div>
	...
	<div class="container col-md-5">
		<div class="card">
			<div class="card-body">
				...
				<fieldset class="form-group">
					<label>Event Decription</label> <input type="text"
						value="<c:out value='${todo.description}' />" class="form-control"
						name="description" minlength="5">
				</fieldset>

				<fieldset class="form-group">
					<label>Event Status</label> <select class="form-control"
						name="isDone">
				...
				<fieldset class="form-group">
					<label>Event Target Date</label> <input type="date"
